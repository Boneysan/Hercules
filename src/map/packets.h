...
packet(0x0efc,clif->pSplitInventoryStack,2,4); // CZ_SPLIT_INVENTORY_STACK (Korangar fork addition)
packet(0x0efb,clif->pReorderInventory,2); // CZ_REORDER_INVENTORY (Korangar fork addition)
